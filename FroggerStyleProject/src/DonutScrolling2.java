...
public class DonutScrolling2{
	...
	public DonutScrolling2() {
		forward 	= getImage("/imgs/"+"donut.png"); //load the image for Tree
	...
	public DonutScrolling2(int x, int y) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = DonutScrolling2.class.getResource(path);
